 ...
 * @LastEditTime: 2023-01-09 21:30:12
...
<template>
  <header
    class="fixed z-10 w-screen h-16 drop-shadow-2xl flex justify-between items-center px-3 backdrop-blur bg-yellow-100/50 dark:bg-slate-800/50"
  >
